...
public class sunActivity extends AppCompatActivity {
    ...
    TextView sunBasic , sunBasic2;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sun);

        sunBasic = (TextView)findViewById(R.id.txtSunBasic);
        Typeface customFont = Typeface.createFromAsset(getAssets(),"fonts/suanaraga.ttf");
        sunBasic.setTypeface(customFont);

        sunBasic2 = (TextView)findViewById(R.id.txtSunBasic2);
        Typeface customFont2 = Typeface.createFromAsset(getAssets(),"fonts/suanaraga.ttf");
        sunBasic2.setTypeface(customFont2);
...
//                        .setAction("Action", null).show();
    ...
    protected void inputNote() {
        LayoutInflater layoutInflater = LayoutInflater.from(sunActivity.this);
        View promptView = layoutInflater.inflate(R.layout.inputnote, null);
        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(sunActivity.this);
                ...
                .setPositiveButton("Add Note", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        ...
                        if (!inputNoteMy.isEmpty()) {
                            ...
                            note.setTopic("The Dawn of the New Year and the Transition Time");
